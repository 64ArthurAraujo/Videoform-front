...
<header class="bg-slate-800 h-12 w-full fixed float-left">
    <div class="h-12 w-fit flex items-center justify-center mx-4">
        ...
        <div class="ml-80 flex">
            <h4 class="text-white float-left">{username}</h4>
        </div>
    </div>
</header>
